...
All Column names are identical to above and they represent the same variables as above but with the variables meaned for each subject and each Activity level.
